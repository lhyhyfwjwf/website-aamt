                            ...
                            <?php 
                                                ...
                                                if(!empty($_GET['error'])){
                                                    ...
                                                    If($error==1){
                                                        ...
                                                        Echo "<font color ='red'>You can't apply as a school, please login in as a teacher if you want to apply!</font>";
                                                    }
                                                }
                                            ?>
                            <br>
                            <form action="/wp-content/themes/consultup-child/apply.php?toid=<?php echo $toid;?>" method="post">
                                <table>
                                    <tr>
